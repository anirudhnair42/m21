...
export const SESSIONS: Session[] = [
  ...
  },
  {
    ...
    sub: "Finish your Questival together, then head straight to the Marina. Dinner, trivia, results.",
    start: T("12", "18:00"), time: "18:00",
    location: "The Loft, 3108B Fillmore St",
    activities: ["sat-doors", "sat-dinner"],
    side: ["sat-after"],
  },
  {
...
export const ACTIVITIES: Activity[] = [
  ...
  },
  {
    ...
    start: T("12", "18:00"),
    time: "18:00",
    title: "Doors at The Loft",
    kind: "optional",
    venue: "The Loft, Marina",
    address: "3108B Fillmore St, San Francisco, CA 94123",
    body: "Come straight from your last quest. Drinks, music, a place to sit down and compare lists.",
  },
  {
    id: "sat-dinner",
    day: "sat",
    ...
    address: "3108B Fillmore St, San Francisco, CA 94123",
    host: "Mau + Ani",
    body: "Dinner served at 7. M21 trivia, a few performances, and grades released at 8:30 — prizes for the top three and the best recreation.",
  ...
  },
  {
    ...
    kind: "peer",
    venue: "Chug Pub",
    address: "1849 Union St, San Francisco, CA 94123",
    host: "Mau",
    body: "The Loft closes at 10. Chug Pub is a ten-minute walk. The night doesn't have to end.",
    goingSeed: ["Mau Urdaneta"],
  },
  // ---------------------------------------------------------------- Sunday
  {
    id: "sun-brunch",
