# Email: the full schedule (draft for Ani, Sept 7)

**From:** anirudhnair42@gmail.com (mail merge, same as the letter)
**To:** every confirmed RSVP (`status in paid, processing`)
**Subject:** RU26 · the run of show

---

Dear {firstName},

Four days. The Forum is open: https://www.m2021.co
...
Assignment 3 is locked on the Forum. It unlocks this week. Bring shoes you can walk in.

See you Friday at six.

Ani, Amal, Anna, Dulce, Mau, Nathan

---

Notes before sending
- Confirm the two open items or soften them: Friday lunch (Spark Social vs Presidio trucks) and the Common Space property. The app shows "address lands in the app" for Common Space and a note on Friday lunch.
- Links: `https://www.m2021.co` (root works on both phone and desktop once signed in). Deep links: `/weekend` (phone), `/?open=itinerary` (desktop Calendar).
- Run `sql/questival.sql` in Supabase BEFORE sending, or the "I'm going" taps don't save.
