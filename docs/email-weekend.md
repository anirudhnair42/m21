# Messenger post: the weekend (paste as-is)

M21s — the weekend is up on the site 🎓

👉 https://www.m2021.co
Sign in with the Google account you RSVP'd with. On your phone it opens straight to the schedule; on a computer it's the Forum you already know.
...
6:00 doors, 7:00 dinner, trivia & Questival results · The Loft, 3108B Fillmore St (everyone)
10:00 PM · Chug Pub, 1849 Lincoln Way (everyone; share rides from The Loft)
...
2. "Plan it" on anything to invite people, or request a one-on-one catch-up from the class list.
3. Housing, if you haven't: Res Hall rooms at 2550 Van Ness, Fri–Mon, $200 per room.

See you Friday at six 🧡
Ani, Amal, Anna, Dulce, Mau, Nathan

---
Before posting: run sql/questival.sql in Supabase (SQL Editor → paste → run) so "I'm going" saves for everyone. Until then taps only live on the tapping phone.
